...
Îl folosim pentru a verifica că site-ul funcționează corect în două limbi: paginile în engleză rămân la adresele obișnuite, iar conținutul românesc este servit sub prefixul `/ro/`.

Când va exista conținut real, fiecare articol va sta fie doar în engleză, fie doar în română, iar rareori în ambele limbi.
